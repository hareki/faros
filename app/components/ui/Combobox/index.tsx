    ...
    <ComboboxPrimitive.List
      ...
      className={cn(
        `
          ...
          scroll-py-1.5 overflow-y-auto overscroll-contain p-1.5
          data-empty:p-0
        `,
        className,
      )}
...
function ComboboxItem({ className, children, ...props }: ComboboxPrimitive.Item.Props) {
  return (
    <ComboboxPrimitive.Item
      ...
      className={cn(
        `
          relative flex w-full cursor-default items-center gap-2.5 rounded-2xl py-2 pr-8 pl-3
...
function ComboboxEmpty({ className }: ComboboxEmptyProps) {
  return (
    <SimpleEmpty
...
function ComboboxChip({
  ...
  return (
    <ComboboxPrimitive.Chip
      ...
      className={cn(
        `
          flex-center h-[calc(--spacing(5.5))] w-fit gap-1 rounded-3xl bg-input px-2 text-xs

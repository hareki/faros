...
function Card({
  ...
  return (
    <div
      ...
      className={cn(
        `
          group/card flex flex-col gap-6 overflow-hidden rounded-4xl bg-card py-6 text-sm
          text-card-foreground shadow-md ring-1 ring-border
...
function CardFooter({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          flex items-center rounded-b-4xl px-6
          group-data-[size=sm]/card:px-4
          [.border-t]:pt-6

    ...
    props: mergeProps<'div'>(
      {
        className: cn(
          `
            flex h-8 shrink-0 items-center rounded-xl px-3 text-xs font-medium
    ...
    props: mergeProps<'button'>(
      {
        className: cn(
          `
            absolute top-3.5 right-3 flex-center aspect-square w-5 rounded-xl p-0
    ...
    props: mergeProps<'button'>(
      {
        className: cn(
          `
            absolute top-1.5 right-1 flex-center aspect-square w-5 rounded-xl p-0
            text-sidebar-foreground ring-sidebar-ring outline-hidden transition-transform
            group-data-[collapsible=icon]:hidden
...
function SidebarMenuBadge({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          pointer-events-none absolute right-1 flex-center h-5 min-w-5 rounded-xl px-1 text-xs

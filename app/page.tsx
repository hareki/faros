...
export default function Home() {
  return (
    ...
    >
      <main
        className='
          flex w-full max-w-3xl flex-1 flex-col items-center justify-between bg-white px-16 py-32
          sm:items-start
          dark:bg-black
        '
      >
        ...
        >
          <a
            className='
              flex h-12 w-full items-center justify-center gap-2 rounded-full bg-foreground px-5
          ...
          <a
            className='
              ...
              border-black/8 px-5 transition-colors

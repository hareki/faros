...
import { accounts, sessions, users } from '@/src/features/auth/db/schema';
...
} from '@/src/features/notification/db/schema';
import { resumes } from '@/src/features/resume/db/schema';

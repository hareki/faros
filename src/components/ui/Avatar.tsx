...
function AvatarFallback({ className, ...props }: AvatarPrimitive.Fallback.Props) {
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        `
          flex-center size-full rounded-full bg-muted text-sm text-muted-foreground
...
function AvatarGroupCount({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          relative flex-center size-8 shrink-0 rounded-full bg-muted text-sm text-muted-foreground

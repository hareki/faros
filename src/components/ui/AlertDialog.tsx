  ...
  return (
    <AlertDialogPortal>
      ...
      <AlertDialogPrimitive.Popup
        ...
        className={cn(
          `
            group/alert-dialog-content fixed top-1/2 left-1/2 z-50 grid w-full -translate-1/2 gap-6
            rounded-4xl bg-popover p-6 text-popover-foreground shadow-xl ring-1 ring-foreground/5
...
function AlertDialogMedia({ className, ...props }: ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn(
        `
          mb-2 inline-flex size-10 items-center justify-center rounded-full bg-muted

...
- [ ] [BE] Configure Better Auth with the table/field mappings shown in `database.dbml` header comment
- [ ] [BE] Enable stateless JWE cookie session (`cookieCache` strategy, no sessions table)
- [ ] [BE] Add Google + GitHub OAuth providers + Vercel env vars
